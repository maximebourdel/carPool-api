...
class LoadVehiculeData extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $listVehicules = array(
            ...
            , array('DM 235 EY', 'Nantes', new \DateTime('2014-12-02'), new \DateTime('2014-12-01'), 'Location', 'Remplaçant de Nolwen De Carvalho', 'Fiesta', 14442, '11/2015 : 21 208  km' )
            ...
            , array('DS 371 XX', 'Nantes', new \DateTime('2016-06-30'), new \DateTime('2015-08-01'), 'Location', 'Remplaçant de Nolwen De Carvalho', 'Fiesta', 24670, '08/2016 : 20  000 km' )            
            , array('DS 608 XX', 'Nantes', new \DateTime('2015-06-30'), new \DateTime('2015-07-01'), 'Location', 'Remplaçant de Nolwen De Carvalho', 'Fiesta', 32767, '2017-04-01' )            
            , array('DS 874 XT', 'Nantes', new \DateTime('2015-06-30'), new \DateTime('2015-07-01'), 'Location', 'Remplaçant de Nolwen De Carvalho', 'Fiesta', 35731, 'fin juin 2017' )            
            , array('DS 507 XV', 'Nantes', new \DateTime('2015-06-30'), new \DateTime('2015-07-01'), 'Location', 'Remplaçant de Nolwen De Carvalho', 'Fiesta', 44737, '05/2016 : 20 000 km' )            
            , array('EK 666 EY', 'Nantes', new \DateTime('2014-04-02'), new \DateTime('2017-04-01'), 'Location', 'Remplaçant de Nolwen De Carvalho', 'Fiesta', 51669, 'Sera à faire au 20 000 km' )            
